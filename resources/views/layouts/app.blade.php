        ...
        <nav class="flex gap-2 overflow-x-auto px-3 py-3 sm:px-4 sm:py-4 lg:block lg:min-h-0 lg:flex-1 lg:space-y-1.5 lg:overflow-x-hidden lg:overflow-y-auto lg:overscroll-contain lg:p-4 lg:pr-3 si-sidebar-scroll">
            ...
            @php
                $menuGroups = [
                    ...
                    'Jadwal & Wahana' => 'Penempatan',
                    'Jadwal Bimbingan' => 'Penempatan',
                    'Jadwal Mahasiswa' => 'Penempatan',
                    ...
                    'Logbook Harian' => 'Pelaksanaan',
                    'Validasi Presensi' => 'Pelaksanaan',
                    'Review Logbook' => 'Pelaksanaan',
                    'Operasional Rotasi' => 'Pelaksanaan',
                    'Pelaksanaan PKPA' => 'Pelaksanaan',
                    ...
                    'Pengaturan Akademik' => 'Akademik & Portofolio',
                    'Akademik PKPA' => 'Akademik & Portofolio',
                    'Bimbingan & Kompetensi' => 'Akademik & Portofolio',
                    ...
                    'Portofolio' => 'Akademik & Portofolio',
                    'Review Portofolio' => 'Akademik & Portofolio',
                    'Review Laporan Akhir' => 'Akademik & Portofolio',
                    'Ujian' => 'Evaluasi',
            ...
            @foreach(($roleData['menu'] ?? ['Dashboard', 'Profil Saya']) as $item)
                @php
                    ...
                    $routeMap = [
                        ...
                        'Preseptor' => 'management.pkpa-preceptors.index',
                        ...
                        'Jadwal & Wahana' => 'student.pkpa-schedule.index',
                        'Jadwal Bimbingan' => 'internal-supervisor.pkpa-schedule.index',
                        'Jadwal Mahasiswa' => 'field-supervisor.pkpa-schedule.index',
                        'Rotasi PKPA' => 'student.pkpa-operations.index',
                        'Presensi Harian' => 'student.pkpa-operations.index',
                        'Logbook Harian' => 'student.pkpa-journals.index',
                        'Akademik Rotasi' => $activeRole === 'mahasiswa' ? 'student.pkpa-academics.index' : 'management.pkpa-academics.index',
                        'Pengaturan Akademik' => 'management.pkpa-academics.index',
                        'Bimbingan & Kompetensi' => match ($activeRole) {
                            'mahasiswa' => 'student.pkpa-academics.index',
                            'pembimbing_lapangan' => 'field-supervisor.pkpa-academics.index',
                            default => 'internal-supervisor.pkpa-academics.index',
                        },
                        ...
                        'Portofolio' => 'student.pkpa-portfolios.index',
                        ...
                        'Penilaian Mahasiswa' => $activeRole === 'pembimbing_lapangan'
                            ? 'field-supervisor.pkpa-assessments.index'
                            : 'internal-supervisor.pkpa-assessments.index',
                        'Operasional Rotasi' => 'management.pkpa-operations.index',
                        'Pelaksanaan PKPA' => 'management.pkpa-operations.index',
                        ...
                        'Mahasiswa Bimbingan' => $activeRole === 'pembimbing_lapangan'
                            ? 'field-supervisor.pkpa-students.index'
                        ...
                        'Antrean Validasi Logbook' => $activeRole === 'pembimbing_lapangan' ? 'field-supervisor.pkpa-journals.index' : 'internal-supervisor.pkpa-journals.index',
                        ...
                        'Review Laporan Akhir' => $activeRole === 'pembimbing_lapangan' ? 'field-supervisor.pkpa-final-reports.index' : 'internal-supervisor.pkpa-final-reports.index',
                    ...
                    $activeMap = [
                        ...
                        'Jadwal & Wahana' => ['student.pkpa-schedule.*', 'student.pkpa-placement.*'],
                        'Jadwal Bimbingan' => ['internal-supervisor.pkpa-schedule.*'],
                        'Jadwal Mahasiswa' => ['field-supervisor.pkpa-schedule.*'],
                        'Rotasi PKPA' => ['student.pkpa-operations.*', 'student.pkpa-attendance.*', 'student.pkpa-logbooks.*'],
                        'Presensi Harian' => ['student.pkpa-operations.*', 'student.pkpa-attendance.*'],
                        'Logbook Harian' => ['student.pkpa-journals.*', 'student.pkpa-logbooks.*'],
                        ...
                        'Portofolio' => ['student.pkpa-portfolios.*'],
                        ...
                        'Penilaian Mahasiswa' => ['field-supervisor.pkpa-assessments.*', 'internal-supervisor.pkpa-assessments.*'],
                        'Operasional Rotasi' => ['management.pkpa-operations.*', 'management.pkpa-rotation-runs.*'],
                        'Pelaksanaan PKPA' => ['management.pkpa-operations.*', 'management.pkpa-rotation-runs.*'],
                        ...
                        'Preseptor' => ['management.pkpa-preceptors.*'],
                        ...
                        'Mahasiswa Bimbingan' => ['internal-supervisor.pkpa-students.*', 'field-supervisor.pkpa-students.*'],
                        ...
                        'Antrean Validasi Logbook' => ['field-supervisor.pkpa-journals.*', 'internal-supervisor.pkpa-journals.*'],
                        'Review Logbook' => ['field-supervisor.pkpa-journals.*', 'internal-supervisor.pkpa-journals.*'],
                        ...
                        'Review Laporan Akhir' => ['internal-supervisor.pkpa-final-reports.*', 'field-supervisor.pkpa-final-reports.*'],
