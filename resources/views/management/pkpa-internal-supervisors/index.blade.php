...
<div class="space-y-5">
    ...
    <div class="rounded-2xl border border-cyan-100 bg-cyan-50/70 p-4 text-sm leading-6 text-cyan-950">
        ...
        <p class="mt-1">Daftarkan dosen dari Core yang boleh menjadi Pembimbing Dalam untuk program dan wahana tertentu. Data ini dipakai saat penyusunan penempatan agar sistem bisa mengecek ketersediaan, batas beban bimbingan, dan status akun Core.</p>
    </div>
    <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <div class="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
            ...
            <a href="{{ route('management.pkpa-internal-supervisors.create') }}" class="rounded-xl bg-cyan-700 px-4 py-2 text-center text-sm font-black text-white">Tambah Pembimbing</a>
        </div>
    </div>
            ...
            <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
                <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-slate-600">{{ $eligibility->program?->code }} - {{ $eligibility->practiceDomain?->name }} / maks. mahasiswa aktif {{ $eligibility->maximum_active_students ?: 'tidak dibatasi' }} / maks. mahasiswa per program {{ $eligibility->maximum_students_per_program ?: 'tidak dibatasi' }}</p>
