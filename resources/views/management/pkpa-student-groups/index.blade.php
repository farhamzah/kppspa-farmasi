@extends('layouts.app')
@section('title', 'Kelompok PKPA - '.config('app.name'))
@section('page_title', 'Kelompok PKPA')
@section('content')
<div class="space-y-5">
    ...
    <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            ...
            <a href="{{ route('management.pkpa-student-groups.create') }}" class="rounded-xl bg-cyan-700 px-4 py-2 text-center text-sm font-black text-white">Tambah Kelompok</a>
        </div>
    </div>
    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        @empty
            <div class="rounded-2xl bg-white p-8 text-center text-slate-500 shadow-sm ring-1 ring-slate-200 md:col-span-2 xl:col-span-3">Belum ada kelompok mahasiswa.</div>
        @endforelse
    </div>
    {{ $groups->links() }}
</div>
