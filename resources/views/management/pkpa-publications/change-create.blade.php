    ...
    <section class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <form method="POST" action="{{ route('management.pkpa-change-requests.store', $publication) }}" class="grid gap-4 lg:grid-cols-2">
            ...
            <div class="lg:col-span-2">
                <label class="text-xs font-black uppercase tracking-widest text-slate-500">Assignment</label>
            ...
            <div class="lg:col-span-2 flex flex-wrap gap-2">
                ...
                <button class="rounded-xl bg-cyan-700 px-4 py-2 text-sm font-black text-white">Buat Permintaan Perubahan</button>
            </div>
        </form>
    </section>
</div>
