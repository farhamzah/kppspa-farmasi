    ...
    <div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200">
        <div class="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
            <form method="GET" class="grid flex-1 gap-3 md:grid-cols-3 xl:grid-cols-[1fr_180px_150px_150px_150px_150px_auto]">
                ...
                <div><label class="text-xs font-black uppercase tracking-widest text-slate-500">Sync</label><select name="sync" class="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 text-sm"><option value="">Semua</option><option value="problem" @selected(($filters['sync'] ?? '') === 'problem')>Bermasalah</option></select></div>
