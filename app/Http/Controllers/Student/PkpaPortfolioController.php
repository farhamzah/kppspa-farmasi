...
class PkpaPortfolioController extends Controller
{
    ...
    public function storeCase(Request $request, PkpaRotationPortfolio $portfolio)
    {
        $data = $request->validate([
            ...
            'drug_data.*.route' => ['nullable', 'string', 'max:100'],
            'drug_data.*.indication' => ['nullable', 'string', 'max:255'],
            'soap' => ['nullable', 'array'],
            ...
            'drp' => ['nullable', 'string'],
            'drp_items' => ['nullable', 'array'],
            'drp_items.*.type' => ['nullable', 'string', 'max:255'],
            'drp_items.*.status' => ['nullable', 'in:ada,tidak'],
            'drp_items.*.note' => ['nullable', 'string'],
