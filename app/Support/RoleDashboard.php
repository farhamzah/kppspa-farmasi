...
class RoleDashboard
{
    public const ROLES = [
        ...
        'pembimbing_dalam' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Jadwal Bimbingan', 'Mahasiswa Bimbingan', 'Monitoring PKPA', 'Review Logbook', 'Bimbingan & Kompetensi', 'Review Portofolio', 'Review Laporan Akhir', 'Penilaian Mahasiswa', 'Jadwal Ujian'],
            'features' => ['Jadwal Bimbingan', 'Mahasiswa Bimbingan', 'Monitoring PKPA', 'Review Logbook', 'Bimbingan & Kompetensi', 'Review Portofolio', 'Review Laporan Akhir', 'Penilaian Mahasiswa', 'Jadwal Ujian'],
        ],
        'pembimbing_lapangan' => [
            'label' => 'Preseptor',
            'route' => 'pembimbing-lapangan.dashboard',
            'path' => '/pembimbing-lapangan/dashboard',
            'menu' => ['Dashboard', 'Profil Saya', 'Jadwal Mahasiswa', 'Mahasiswa Bimbingan', 'Validasi Presensi', 'Review Logbook', 'Bimbingan & Kompetensi', 'Review Portofolio', 'Review Laporan Akhir', 'Penilaian Mahasiswa'],
            'features' => ['Jadwal Mahasiswa', 'Mahasiswa Bimbingan', 'Validasi Presensi', 'Review Logbook', 'Bimbingan & Kompetensi', 'Review Portofolio', 'Review Laporan Akhir', 'Penilaian Mahasiswa'],
        ],
        'penguji' => [
            'label' => 'Penguji',
