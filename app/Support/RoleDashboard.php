...
class RoleDashboard
{
    public const ROLES = [
        ...
        'pembimbing_dalam' => [
            ...
            'menu' => ['Dashboard', 'Profil Saya', 'Jadwal PKPA', 'Mahasiswa Bimbingan', 'Pemantauan PKPA', 'Antrean Validasi Logbook', 'Akademik PKPA', 'Review Portofolio', 'Pemeriksaan Laporan', 'Penilaian PKPA', 'Jadwal Ujian'],
            'features' => ['Jadwal PKPA', 'Mahasiswa Bimbingan', 'Pemantauan PKPA', 'Antrean Validasi Logbook', 'Akademik PKPA', 'Review Portofolio', 'Pemeriksaan Laporan', 'Penilaian PKPA', 'Jadwal Ujian'],
        ],
        'pembimbing_lapangan' => [
            'label' => 'Preseptor',
            'route' => 'pembimbing-lapangan.dashboard',
            'path' => '/pembimbing-lapangan/dashboard',
            'menu' => ['Dashboard', 'Profil Saya', 'Jadwal PKPA', 'Mahasiswa PKPA', 'Operasional PKPA', 'Antrean Validasi Logbook', 'Akademik PKPA', 'Review Portofolio', 'Pemeriksaan Laporan', 'Penilaian Preseptor'],
            'features' => ['Jadwal PKPA', 'Mahasiswa PKPA', 'Operasional PKPA', 'Antrean Validasi Logbook', 'Akademik PKPA', 'Review Portofolio', 'Pemeriksaan Laporan', 'Penilaian Preseptor'],
        ],
        'penguji' => [
            'label' => 'Penguji',
