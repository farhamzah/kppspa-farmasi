    ...
    public function studentRows(Request $request): Collection
    {
        return $this->assignmentQuery($request)
            ...
            ->map(fn (KpAssignment $assignment) => [
                ...
                'Preseptor' => $assignment->fieldSupervisor ? field_supervisor_display_name($assignment->fieldSupervisor) : '-',
        ...
        return $this->assignmentQuery($request)
            ...
            ->map(function (KpAssignment $assignment) {
                ...
                return [
                    ...
                    'Nilai Preseptor' => $breakdown['sections']['pembimbing_lapangan']['score'],
                    'Kontribusi Preseptor' => $breakdown['sections']['pembimbing_lapangan']['contribution'],
