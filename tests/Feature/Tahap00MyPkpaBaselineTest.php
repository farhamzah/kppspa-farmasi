...
class Tahap00MyPkpaBaselineTest extends TestCase
{
    use RefreshDatabase;
    ...
    protected function setUp(): void
    {
        ...
        config()->set('my_pkpa.local_account_management_enabled', false);
        config()->set('my_pkpa.student_place_selection_enabled', false);
    }

    public function test_landing_page_is_public_and_branded_as_my_pkpa(): void
    {
        $this->get('/')
            ->assertOk()
            ->assertSee('MY PKPA')
    ...
    public function test_core_http_login_denies_cleanly_when_only_unknown_roles_are_returned(): void
    {
        ...
        $this->post('/login', [
            ...
            ->assertSessionHasErrors(['email' => 'Akun Core Anda belum memiliki akses aplikasi MY PKPA / MY PKPA.']);
    ...
    public function test_logout_clears_my_pkpa_session(): void
    {
        $user = User::create([
            'name' => 'User',
