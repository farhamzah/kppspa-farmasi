...
use App\Http\Controllers\Management\PkpaCapacityReportController;
...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::middleware('role.selected')->group(function () {
        ...
        Route::middleware('role:admin,koordinator_kp')->prefix('management')->name('management.')->group(function () {
            ...
            Route::get('pkpa-capacity-reports/{type}/preview', [PkpaCapacityReportController::class, 'preview'])->name('pkpa-capacity-reports.preview');
            Route::get('pkpa-capacity-reports/{type}/download/{format}', [PkpaCapacityReportController::class, 'download'])->name('pkpa-capacity-reports.download');
        ...
        Route::middleware('role:mahasiswa')->prefix('mahasiswa')->name('student.')->group(function () {
            ...
            Route::post('jurnal-pkpa/periode-kerja', [LogbookController::class, 'updateWorkPeriod'])->name('pkpa-journals.work-period.update');
