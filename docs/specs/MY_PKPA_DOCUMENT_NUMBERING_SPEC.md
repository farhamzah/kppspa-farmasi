# MY PKPA Document Numbering Spec

Penomoran dokumen dikonfigurasi melalui `pkpa_document_numbering_rules`. MY PKPA tidak menyediakan format nomor surat resmi default.
