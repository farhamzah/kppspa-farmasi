# MY PKPA Backup Restore Simulation Report

Tanggal: 2026-07-17

Metode:
- Clean install SQLite dibuat di `C:\tmp\my_pkpa_tahap11a_clean.sqlite`.
- File disalin ke `C:\tmp\my_pkpa_tahap11a_clean_backup.sqlite`.
- Backup disalin ke `C:\tmp\my_pkpa_tahap11a_restore.sqlite`.
- SHA256 dibandingkan.
