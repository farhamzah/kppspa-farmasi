# MY PSPA AI Pre-UAT Execution Sheet
...
| Clean install | SQLite clean database | `migrate:fresh --seed --force` pada `C:\tmp\my_pspa_tahap11a_clean.sqlite` | Pass | Semua migration dan seeder selesai |
